 ...
 *
 * Shared engine, kept in sync with miro-app/src/redact.ts (the canonical copy).
 * Pure TypeScript: no DOM, no network, no storage — safe to run anywhere,
 * including inside an MCP server.
 */
